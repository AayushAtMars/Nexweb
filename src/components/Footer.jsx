...
const Footer = () => {
  const links = {
    Services: ["System Architecture", "Brand & Identity", "Web Development", "Marketing Automation", "Paid Media", "SEO & Content"],
    Company: ["About Us", "Our Approach", "Case Studies", "Insights", "Careers", "Contact"],
    ...
    <footer style={{ backgroundColor: "#0f0520" }} className="w-full text-white">
      ...
      >
        ...
        <p className="text-sm max-w-md mx-auto mb-10" style={{ color: "#c4b8e8" }}>
          Book a free diagnostic session and walk away with a clear picture of your growth infrastructure gaps — and how to fix them.
        </p>
        <a
          href="#"
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-5">
              ...
              <span className="text-white font-bold text-lg">Godigitify<sup className="text-xs font-normal">™</sup></span>
            </div>
            <p className="text-sm leading-relaxed mb-8" style={{ color: "#9ca3af" }}>
              We architect integrated digital ecosystems that replace fragmented tactics with predictable, automated growth infrastructure.
            </p>
            {/* Social icons */}
            <div className="flex gap-4">
              {["LinkedIn", "Twitter", "Instagram"].map((s) => (
                <a
                  key={s}
                  href="#"
                  className="w-9 h-9 rounded-full border flex items-center justify-center text-xs font-medium transition-colors hover:border-white hover:text-white"
          ...
          {Object.entries(links).map(([col, items]) => (
            <div key={col}>
              <h4 className="text-xs font-bold tracking-widest uppercase mb-5" style={{ color: "#c4b8e8" }}>
                {col}
              </h4>
